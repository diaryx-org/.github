...
This is a GitHub organization for the Diaryx project. You can read about Diaryx at <https://diaryx.org>.

**Diaryx is closed-source**, but much of its logic is contained in open-source MIT/Apache-2.0-licensed repositories:

- [Fig](https://github.com/diaryx-org/fig) (config file parser/editor in Zig)
